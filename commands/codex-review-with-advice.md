...
---
Use the **handoff-codex-with-advice** skill with role `review`, cwd `$(pwd)`, and request
`$ARGUMENTS`. Use the exact root `handoff.mjs run-with-advice --caller-harness claude --harness codex --mode review` flow.
