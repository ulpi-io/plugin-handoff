...
---
Use the **handoff-grok-with-advice** skill with role `build`, cwd `$(pwd)`, and request
`$ARGUMENTS`. Use the exact root `handoff.mjs run-with-advice --caller-harness claude --harness grok --mode build` flow.
